...
// this function loops through strNums and converts them to intergers
const nums = strNums.map(i => Number(i));
console.log(nums);

//this function loops through the array of integers "nums" and finds even numbers using the % operator
const evenNumbers = nums.filter(num => num % 2 === 0);

// this function adds all even numbers
...
//   return num % 2 === 0;
// };
// //find the even numbers in my nums array and return them to myEvens array
// const myEvens = nums.filter(even);
//
...
//
// }
// //this function loops through the myEvens array and adds all even numbers in array together and returns the sum to a new array called sumEvens
// const sumEvens = myEvens.reduce(getSum)
//
...
//returning the "tally" of the occurrences into an object
const numCount = nums.reduce((tally, num) => {
